...
with tab2:
    ...
    with video_desc_tab:
        ...
        video_uri = "gs://news-videofiles/news/Adolescente filha de brasileiros está desaparecida em Nova Jersey.mp4"
        ...
        transcription_prompt = f"""Transcreva o seguinte vídeo em português: {video_uri}""" 
